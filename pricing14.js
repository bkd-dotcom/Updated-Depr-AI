        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2 className="pricing14-text101 thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="pricing14-text183">Pricing plan</span>
                </Fragment>
              )}
            </h2>
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3 className="pricing14-text108 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing14-text194">$9.99/month</span>
                      </Fragment>
                    )}
                  </h3>
                      ...
                      {props.plan1Feature1 ?? (
                        <Fragment>
                          <span className="pricing14-text162">
                            Access to mental health tracking tools
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan1Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text164">
                            Unlimited access to depression assessment
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3 className="pricing14-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing14-text189">$19.99/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                      ...
                      {props.plan2Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text198">
                            24/7 access to online therapy sessions
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan2Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text177">
                            Personalized mental health improvement plan
                          </span>
                        </Fragment>
                      )}
                    </span>
            ...
            <div className="pricing14-column3 thq-card">
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <h3 className="pricing14-text123 thq-heading-3">
                    {props.plan3Price ?? (
                      <Fragment>
                        <span className="pricing14-text178">$29.99/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                      ...
                      {props.plan3Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text205">
                            Priority access to licensed therapists
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan3Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text188">
                            Monthly in-person therapy sessions
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <button className="pricing14-button16 thq-button-filled thq-button-animated">
                <span className="thq-body-small">
                  {props.plan3Action ?? (
                    <Fragment>
                      <span className="pricing14-text204">Sign up now</span>
                    </Fragment>
                  )}
                </span>
              </button>
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  <span className="pricing14-text131 thq-body-large">
                    {props.plan11 ?? (
                      <Fragment>
                        <span className="pricing14-text206">Basic plan</span>
                      </Fragment>
                    )}
                  </span>
                  <h3 className="pricing14-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text161">$200/yr</span>
                      </Fragment>
                    )}
                  </h3>
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3 className="pricing14-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text172">$299/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <h3 className="pricing14-text147 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text159">$499/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
