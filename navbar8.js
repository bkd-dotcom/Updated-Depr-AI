        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text15">#test</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text14">#results</span>
                  </Fragment>
                )}
              </span>
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-filled thq-button-animated">
              ...
              >
                {props.text4 ?? (
                  <Fragment>
                    <span className="navbar8-text28">Link</span>
                  </Fragment>
                )}
              </a>
            </button>
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text26">Take the Test</span>
                  </Fragment>
                )}
              </span>
              <a
              ...
              >
                {props.text2 ?? (
                  <Fragment>
                    <span className="navbar8-text29">Link</span>
                  </Fragment>
                )}
              </a>
            </button>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text25">
                                  Welcome to Dep.AI, track your mental health
                                  status here.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text24">
                                  Learn more about Dep.AI and how we can help
                                  you.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text22">
                                  Take the depression test to assess your mental
                                  health.
                                </span>
                              </Fragment>
                            )}
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text23">Results</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text20">
                                  View your test results and get guidance on
                                  next steps.
                                </span>
                              </Fragment>
                            )}
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text25">
                            Welcome to Dep.AI, track your mental health status
                            here.
                          </span>
                        </Fragment>
                      )}
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text17">Take the Test</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                  ...
                  <div className="navbar8-content8">
                    ...
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text20">
                            View your test results and get guidance on next
                            steps.
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  ...
  page4ImageAlt: 'Results Image',
  logoAlt: 'Dep.AI Logo',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1666803276449-0463d11dbdc8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODgxNTE5Mnw&ixlib=rb-4.0.3&q=80&w=1080',
  action2: undefined,
  page2: undefined,
  text4: undefined,
  ...
  page4ImageSrc:
    'https://images.unsplash.com/photo-1542776631-741a60ebaf7a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODgxNTE5Mnw&ixlib=rb-4.0.3&q=80&w=1080',
  link3Url: 'https://www.teleporthq.io',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1466428996289-fb355538da1b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODgxNTE5MXw&ixlib=rb-4.0.3&q=80&w=1080',
